            ...
            .then(response => 
                response.json())
                    .then(data => {
                        ...
                        document.querySelector(".dayOneImg").innerHTML= "<img src='" + `http://openweathermap.org/img/w/${data.list[0].weather[0].icon}.png`+"'" + "style='width: 60px;' alt='Icon'></img>";
                        ...
                        document.querySelector(".dayTwoImg").innerHTML= "<img src='" + `http://openweathermap.org/img/w/${data.list[8].weather[0].icon}.png`+"'" + "style='width: 60px;' alt='Icon'></img>";
                        ...
                        document.querySelector(".dayThreeImg").innerHTML= "<img src='" + `http://openweathermap.org/img/w/${data.list[16].weather[0].icon}.png`+"'" + "style='width: 60px;' alt='Icon'></img>";
                        ...
                        document.querySelector(".dayFourImg").innerHTML= "<img src='" + `http://openweathermap.org/img/w/${data.list[24].weather[0].icon}.png`+"'" + "style='width: 60px;' alt='Icon'></img>";
                        ...
                        document.querySelector(".dayFiveImg").innerHTML= "<img src='" + `http://openweathermap.org/img/w/${data.list[32].weather[0].icon}.png`+"'" + "style='width: 60px;' alt='Icon'></img>";
                    }); 
    })
}
